...
def main():
    ...
    for i in range(0,100):
        draw_uncurated_result_figure(os.path.join(config.result_dir, 'uncurated-anime-{i}.png'.format(i)), load_Gs2(url_anime), cx=0, cy=0, cw=64, ch=64, rows=1, lods=[0], seed=random.randint(1,10100))
